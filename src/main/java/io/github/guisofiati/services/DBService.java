...
import io.github.guisofiati.domain.Endereco;
...
import io.github.guisofiati.domain.enums.Perfil;
import io.github.guisofiati.domain.enums.TipoCliente;
import io.github.guisofiati.repositories.CategoriaRepository;
import io.github.guisofiati.repositories.CidadeRepository;
import io.github.guisofiati.repositories.ClienteRepository;
import io.github.guisofiati.repositories.EnderecoRepository;
import io.github.guisofiati.repositories.EstadoRepository;
...
import io.github.guisofiati.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		cli1.getTelefones().addAll(Arrays.asList("27363323", "938383932"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa",
				"anacostasilva@hotmail.com",
				"01353158080",
				TipoCliente.PESSOAFISICA,
				pe.encode("123")
				);		
		cli2.getTelefones().addAll(Arrays.asList("45804299", "945673468"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", 
				"300", "Apto 303", "Jardim", "38220834", 
				cli1, c1);
		
		Endereco e2 = new Endereco(null, "Avenida Matos", 
				"105", "Sala 800", "Centro", "38777012", 
				cli1, c2);
		
		Endereco e3 = new Endereco(null, "Avenida Floriano", 
				"2106", null, "Centro", "22246782", 
				cli2, c2);
